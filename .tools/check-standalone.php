...
// SPOT ist der EIGENE Präfix dieses Repos und gehört daher NICHT in die
// Liste — sonst meldet das Skript die eigenen Funktionen als ungeschützte
// Fremdaufrufe.
const FOREIGN_PREFIXES = ['IHUB', 'IHUBD', 'IHUBNRG', 'IHUBMON', 'IHUBTILE', 'MHUB', 'MHUBV', 'CHUB', 'MIGHUB', 'PVF', 'LFC', 'HEISHA', 'WPHUB', 'SGW', 'SBH', 'TIBBERGR', 'TESSIE', 'EMS', 'NRGDASH', 'MODBUS', 'GWET', 'STRUKT', 'RAVG', 'OHUB', 'WARN', 'PFOE', 'SCHEIN'];
